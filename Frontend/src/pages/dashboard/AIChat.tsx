...
//                             className={`inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-2xl border border-slate-800/80 bg-slate-900 text-slate-400 transition hover:border-slate-600 hover:text-white opacity-0 group-hover:opacity-100 ${activeMenu === session.id ? "opacity-100" : ""}`}
//                           >
