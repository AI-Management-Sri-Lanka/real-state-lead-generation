    ...
    <div className={`auth-brand-panel ${className ?? ""}`} style={{
      ...
      <div className="auth-brand-logo">
        <Link to="/" style={{ display:'flex', alignItems:'center', gap:10, textDecoration:'none' }}>
          <div className="auth-brand-logo-icon" style={{ background:'rgba(255,255,255,0.15)', backdropFilter:'blur(8px)', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
      ...
      {/* Main content — bottom aligned on desktop, stacks under the logo on mobile */}
      <div className="auth-brand-content" style={{ position:'relative', zIndex:1 }}>
